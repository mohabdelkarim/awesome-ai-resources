...
Thanks for helping keep this list high-signal and trustworthy.
...
2. Add the entry in the correct section of `README.md`
3. Use this format:
...
## Suggesting without a PR

Open an issue with the **Resource suggestion** template if you prefer maintainers to add it.

## Link health

URLs are auto-checked every Thursday. Broken links are repaired or flagged in `link-health-report.md`.
